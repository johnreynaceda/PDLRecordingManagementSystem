    ...
    <x-modal.card title="PDL DATA FORM" fullscreen blur wire:model.defer="view_modal">
        ...
        <x-slot name="footer">
            <div class="flex  justify-end gap-x-4" wire:key="{{ $edit_data }}">
                <x-button dark label="Print" icon="printer" @click="printOut($refs.printContainer.outerHTML);" />
                <x-button positive label="Edit Record" icon="pencil-alt" wire:click="editRecord"
                    spinner="editRecord" />
                <div class="flex">
