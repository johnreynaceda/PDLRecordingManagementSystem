                ...
                <div class="flex justify-center mt-10 items-center">
                    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" class="h-80" viewBox="0 0 797.5 834.5"
                        ...
                        <path
                            ...
                            transform="translate(-201.25 -32.75)" fill="#2f2e41" />
                        <circle cx="559" cy="744.5" r="43" fill="#363756" />
                        <circle cx="54" cy="729.5" r="43" fill="#363756" />
                        <circle cx="54" cy="672.5" r="31" fill="#363756" />
                        <circle cx="54" cy="624.5" r="22" fill="#363756" />
                    </svg>
                    <h1></h1>
                </div>
        @endswitch
